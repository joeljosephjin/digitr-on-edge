...
var c=[],e=["onExit","onAbort","print","printErr"],h;for(h of e)w.hasOwnProperty(h)&&c.push(h);a.postMessage({cmd:"load",handlers:c,urlOrBlob:w.mainScriptUrlOrBlob||_scriptDir,wasmMemory:d,wasmModule:ra})}),ib:function(a){a()},cb:function(){var a=la("ort-wasm-simd-threaded.worker.js");a=new Worker(a);V.Ra.push(a)},fb:function(){0==V.Ra.length&&(V.cb(),V.jb(V.Ra[0]));return V.Ra.pop()}};w.PThread=V;var Pa=a=>{for(;0<a.length;)a.shift()(w)};
